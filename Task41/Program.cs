...
//------------------------------------------------------------------------------------------------------
int[] InputIntArrayWithSheck(int size)
{
...
System.Console.WriteLine("Количество положительных чисел во введенном массиве: "+CountPositiveValueInIntArray(arr));